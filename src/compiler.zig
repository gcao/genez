...
pub fn compile(ctx: CompilationContext, nodes: []ast.AstNode) !bytecode.Function {
    // std.debug.print("[DEBUG_TRACE] Entering compiler.compile\n", .{}); // TRACE 1
    ...
    // std.debug.print("[DEBUG_TRACE] Completed ast_to_hir.convert\n", .{}); // TRACE 2
    ...
    // std.debug.print("[DEBUG_TRACE] Completed hir_to_mir.convert\n", .{}); // TRACE 3
    ...
    // std.debug.print("[DEBUG_TRACE] Completed mir_to_bytecode.convert\n", .{}); // TRACE 4
